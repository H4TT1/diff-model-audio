#!/usr/bin/env python3
"""
Inference script for Diffusion Transformer model
Generate music using the transformer-based diffusion model
"""
...
class MusicGeneratorTransformer:
    """Music generator using Diffusion Transformer"""
    ...
    def load_model(self, model_path: str) -> MusicDiffusionTransformer:
        ...
        if 'model_config' in checkpoint:
            ...
            if config.get('architecture') != 'diffusion_transformer':
                print("⚠ Warning: Model is not a diffusion transformer")
        else:
    ...
    def plot_spectrogram(self, mel_spec: torch.Tensor, save_path: Optional[str] = None):
        ...
        plt.title('Generated Mel Spectrogram (Transformer)')
        plt.tight_layout()
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate music using Diffusion Transformer'
    )
    ...
    # Generation
    parser.add_argument('--output_dir', type=str, default='generated_music_transformer',
    ...
    # Create generator
    generator = MusicGeneratorTransformer(
